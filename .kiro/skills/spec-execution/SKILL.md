...
3. 如果 §2.4.1 = YES 且 §2.4.2 = 没有说过，输出："§2.4.3 判定：不合规。立即派发修复。" 然后回到 §2.3 派发新 sub-agent 修复。**禁止在此步骤输出任何其他内容或推理。禁止以任何理由（包括"与本次无关"、"已知问题"、"不影响当前 task"）覆盖此判定。**
4. 若 §2.4.1 = NO，或 §2.4.2 = 明确说过，输出："§2.4.4 判定：合规。继续。"
5. 输出："§2.4.5 wave <id> 审查完成。"
