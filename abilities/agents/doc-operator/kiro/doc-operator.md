...
格式与目录规范见 `docs/README.md`（notes 小节）。
...
2. 读取 `docs/README.md` 的 notes 小节获取格式规范
...
1. 确认当前在 develop 分支
2. 读取 `docs/README.md` 的 proposals 小节获取格式规范和编号规则
...
完整的状态定义、内容结构、归档规则见 `docs/README.md` 的 proposals 小节。
