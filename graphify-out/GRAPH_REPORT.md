...
1. `Assert` - 710 edges
2. `Configuration` - 314 edges
3. `Standard` - 189 edges
...
- `Assert` --calls--> `assertCommandIsSuccessful()`  [INFERRED]
  /Users/zhangminhao/git/ai-profile-manager/vendor/phpunit/phpunit/src/Framework/Assert.php → /Users/zhangminhao/git/ai-profile-manager/vendor/symfony/console/Tester/TesterTrait.php
- `setAttribute()` --calls--> `I()`  [INFERRED]
  /Users/zhangminhao/git/ai-profile-manager/vendor/nikic/php-parser/lib/PhpParser/Node.php → /Users/zhangminhao/git/ai-profile-manager/vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/js/jquery.min.js
- `setAttribute()` --calls--> `V()`  [INFERRED]
  /Users/zhangminhao/git/ai-profile-manager/vendor/nikic/php-parser/lib/PhpParser/Node.php → /Users/zhangminhao/git/ai-profile-manager/vendor/phpunit/php-code-coverage/src/Report/Html/Renderer/Template/js/jquery.min.js
- `Method` --calls--> `expects()`  [INFERRED]
  /Users/zhangminhao/git/ai-profile-manager/vendor/phpunit/php-code-coverage/src/Report/Xml/Method.php → /Users/zhangminhao/git/ai-profile-manager/vendor/phpunit/phpunit/src/Framework/MockObject/Runtime/Api/MockObjectApi.php
- `Generators` --calls--> `constant()`  [INFERRED]
  /Users/zhangminhao/git/ai-profile-manager/vendor/giorgiosironi/eris/src/Generators.php → /Users/zhangminhao/git/ai-profile-manager/vendor/giorgiosironi/eris/src/Generator/ConstantGenerator.php
...
Cohesion: 0.01
Nodes (134): Assign, _(), a(), b(), be(), c(), Ce(), d() (+126 more)
...
Cohesion: 0.03
Nodes (12): CollectingDispatcher, DirectDispatcher, DispatchingEmitter, IgnorePhpunitDeprecations, Info, peakMemoryUsage(), MemoryUsage, Output (+4 more)
...
Cohesion: 0.17
Nodes (10): /graphify, 任务路由, 增量更新, 导出与重组, 构建图谱, 查询图谱, 添加内容与自动化, 用法速查 (+2 more)

### Community 98 - "Community 98"
Cohesion: 0.17
Nodes (10): Agent 交互流程, Wiki 表格的 SPREADSHEET_TOKEN, 依赖, 关键经验, 敏感信息规范, 网络前提, 详细 API 参考, 追加写入用 PUT，不用 values_append (+2 more)

### Community 99 - "Community 99"
Cohesion: 0.17
Nodes (10): Goal Clarification 规则, Goal 阶段（产物：goal.md）, TOC, 产物位置, 产物格式, 完成后输出, 执行步骤, 文档结构 (+2 more)

### Community 100 - "Community 100"
Cohesion: 0.17
Nodes (11): Discussion 不写入 gk-logs, Gatekeep Log 格式, Gatekeep Log 规则, GK Log Format, Phase 名称, Section 顺序（强制）, Socratic Review 格式, Socratic Review 规则 (+3 more)

### Community 101 - "Community 101"
Cohesion: 0.17
Nodes (11): 1. 用 Scoop 安装 PHP 与 Composer, 2. 全局安装 apm CLI, 3. 三阶段首装, Path 与 `Get-Command`, Windows Install (Scoop), 参考环境, 多个 `vendor\bin`, 排障 (+3 more)
...
- **Are the 119 inferred relationships involving `Generators` (e.g. with `.testBootstrapIncludesRoundTripPreservation()` and `.testLegacyScopesFieldFailFastOnFirstViolation()`) actually correct?**
  _`Generators` has 119 INFERRED edges - model-reasoned connections that need verification._
- **What connects `CloneException`, `PropertyException`, `SplDoublyLinkedList` to the rest of the system?**
